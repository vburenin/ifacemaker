...
type cmdlineArgs struct {
	...
	Format string `short:"F" long:"format" description:"Format tool" choice:"imports" choice:"none" default:"imports"`
}
...
func main() {
	...
	result, err := maker.Make(files, args.StructType, args.Comment, args.PkgName, args.IfaceName, args.IfaceComment, args.copyDocs, args.CopyTypeDoc, args.Format)
	if err != nil {
		log.Fatal(err.Error())
	}
